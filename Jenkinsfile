...
// for display purposes
      ...
      git 'https://github.com/suresh352/hello-world-servlet.git'
...
post {
        success {
            mail to:"suresh352@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"suresh352@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
